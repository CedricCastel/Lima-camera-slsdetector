...
public:
    ...
    void setupUi(QWidget *TabAdvancedObject)
    {
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(25, 20, 324, 31));
        ...
        horizontalLayoutWidget->setGeometry(QRect(230, 15, 242, 44));
        ...
        gridLayoutWidget->setGeometry(QRect(25, 20, 195, 31));
        ...
        spinExpTime->setDecimals(9);
        spinExpTime->setMinimum(-1);
